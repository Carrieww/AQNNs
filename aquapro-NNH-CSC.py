...
from hyper_parameter import pilot_eps, pilot_size
import numpy as np
    ...
    for sample_size in sample_size_list:
        ...
        for Pt in [0.4, 0.5, 0.6, 0.7, 0.8, 0.9]:
            ...
            for sample_ind in range(num_sample):
                ...
                K_rt = floor(len(true_ans_S) * (1 - Rt)) + 1
                K_pt = find_K_pt(ranks_S, oracle_dist_S, t=Dist_t, pt=Pt)
            ...
            Path(f"./results_NNH/CSC/").mkdir(parents=True, exist_ok=True)
            ...
            for fac in fac_list:
                ...
                with open(
                    ...
                    + "_"
                    + H1_op
                    + f"_query{str(seed)}_0907_50.txt",
                    "a",
                ) as file:
